...
class MarketplaceWebServiceProducts_Model_GetMatchingProductForIdResponse extends MarketplaceWebServiceProducts_Model
{
    ...
    {
        $this->_fields = array(
            'GetMatchingProductForIdResult' => array(
                'FieldValue' => array(),
                'FieldType' => array('MarketplaceWebServiceProducts_Model_GetMatchingProductForIdResult')
            ),
     ...
     *
     * @return MarketplaceWebServiceProducts_Model_GetMatchingProductForIdResult[] GetMatchingProductForIdResult.
     */
     ...
     *
     * @param array $value getMatchingProductForIdResult
