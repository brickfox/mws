...
class FBAInboundServiceMWS_Model_GetTransportContentResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'GetTransportContentResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_GetTransportContentResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_GetTransportContentResult GetTransportContentResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_GetTransportContentResult $value getTransportContentResult
