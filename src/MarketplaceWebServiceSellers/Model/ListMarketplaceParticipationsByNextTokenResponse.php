...
class MarketplaceWebServiceSellers_Model_ListMarketplaceParticipationsByNextTokenResponse extends MarketplaceWebServiceSellers_Model
{
    ...
    {
        $this->_fields = array(
            'ListMarketplaceParticipationsByNextTokenResult' => array(
                'FieldValue' => null,
                'FieldType' => 'MarketplaceWebServiceSellers_Model_ListMarketplaceParticipationsByNextTokenResult'
            ),
            'ResponseMetadata' => array(
                'FieldValue' => null,
                'FieldType' => 'MarketplaceWebServiceSellers_Model_ResponseMetadata'
            ),
            'ResponseHeaderMetadata' => array(
                'FieldValue' => null,
                'FieldType' => 'MarketplaceWebServiceSellers_Model_ResponseHeaderMetadata'
            ),
        );
     ...
     *
     * @return MarketplaceWebServiceSellers_Model_ResponseMetadata ResponseMetadata.
     */
     ...
     *
     * @return MarketplaceWebServiceSellers_Model_ResponseHeaderMetadata ResponseHeaderMetadata.
     */
