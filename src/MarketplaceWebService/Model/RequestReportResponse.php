...
class MarketplaceWebService_Model_RequestReportResponse extends MarketplaceWebService_Model
{
    ...
    public function __construct($data = null)
    {
        $this->fields = array(
            'RequestReportResult' => array(
                'FieldValue' => null,
                'FieldType' => 'MarketplaceWebService_Model_RequestReportResult'
            ),
     ...
     *
     * @return MarketplaceWebService_Model_RequestReportResult RequestReportResult
     */
     ...
     *
     * @param MarketplaceWebService_Model_RequestReportResult $value RequestReportResult
     * @return void
     */
