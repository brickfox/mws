...
class FBAInboundServiceMWS_Model_GetPrepInstructionsForASINResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'GetPrepInstructionsForASINResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_GetPrepInstructionsForASINResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_GetPrepInstructionsForASINResult GetPrepInstructionsForASINResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_GetPrepInstructionsForASINResult $value getPrepInstructionsForASINResult
