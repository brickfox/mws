...
class FBAInventoryServiceMWS_Model_GetServiceStatusResponse extends FBAInventoryServiceMWS_Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            'GetServiceStatusResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInventoryServiceMWS_Model_GetServiceStatusResult'
            ),
     ...
     *
     * @return FBAInventoryServiceMWS_Model_GetServiceStatusResult GetServiceStatusResult.
     */
     ...
     *
     * @param FBAInventoryServiceMWS_Model_GetServiceStatusResult $value getServiceStatusResult
