...
class FBAInboundServiceMWS_Model_NonPartneredSmallParcelPackageOutputList extends FBAInboundServiceMWS_Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            'member' => array(
                'FieldValue' => array(),
                'FieldType' => array('FBAInboundServiceMWS_Model_NonPartneredSmallParcelPackageOutput')
            ),
        );
     ...
     *
     * @return FBAInboundServiceMWS_Model_NonPartneredSmallParcelPackageOutput[] member.
     */
