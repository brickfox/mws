...
class FBAInboundServiceMWS_Model_ListInboundShipmentsResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'ListInboundShipmentsResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_ListInboundShipmentsResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_ListInboundShipmentsResult ListInboundShipmentsResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_ListInboundShipmentsResult $value listInboundShipmentsResult
