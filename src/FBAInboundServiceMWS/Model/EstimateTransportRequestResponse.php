...
class FBAInboundServiceMWS_Model_EstimateTransportRequestResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'EstimateTransportRequestResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_EstimateTransportRequestResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_EstimateTransportRequestResult EstimateTransportRequestResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_EstimateTransportRequestResult $value estimateTransportRequestResult
