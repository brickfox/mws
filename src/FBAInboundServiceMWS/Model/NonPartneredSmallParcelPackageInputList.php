...
class FBAInboundServiceMWS_Model_NonPartneredSmallParcelPackageInputList extends FBAInboundServiceMWS_Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            'member' => array(
                'FieldValue' => array(),
                'FieldType' => array('FBAInboundServiceMWS_Model_NonPartneredSmallParcelPackageInput')
            ),
        );
     ...
     *
     * @return FBAInboundServiceMWS_Model_NonPartneredSmallParcelPackageInput[] member.
     */
