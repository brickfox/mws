...
class FBAInboundServiceMWS_Model_VoidTransportRequestResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'VoidTransportRequestResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_VoidTransportRequestResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_VoidTransportRequestResult VoidTransportRequestResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_VoidTransportRequestResult $value voidTransportRequestResult
