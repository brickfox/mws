...
class FBAOutboundServiceMWS_Model_FulfillmentPreviewShipmentList extends FBAOutboundServiceMWS_Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            'member' => array(
                'FieldValue' => array(),
                'FieldType' => array('FBAOutboundServiceMWS_Model_FulfillmentPreviewShipment')
            ),
        );
     ...
     *
     * @return FBAOutboundServiceMWS_Model_FulfillmentPreviewShipment[] member.
     */
     ...
     *
     * @param FBAOutboundServiceMWS_Model_FulfillmentPreviewShipment[] $value
