...
class FBAInboundServiceMWS_Model_CreateInboundShipmentResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'CreateInboundShipmentResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_CreateInboundShipmentResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_CreateInboundShipmentResult CreateInboundShipmentResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_CreateInboundShipmentResult $value createInboundShipmentResult
