...
class FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'ListInboundShipmentsByNextTokenResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResult ListInboundShipmentsByNextTokenResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResult $value listInboundShipmentsByNextTokenResult
