...
class FBAInboundServiceMWS_Model_ListInboundShipmentItemsResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'ListInboundShipmentItemsResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_ListInboundShipmentItemsResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_ListInboundShipmentItemsResult ListInboundShipmentItemsResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_ListInboundShipmentItemsResult $value listInboundShipmentItemsResult
