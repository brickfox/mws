...
class FBAInboundServiceMWS_Model_ListInboundShipmentItemsByNextTokenResponse extends FBAInboundServiceMWS_Model
{
    ...
    {
        $this->_fields = array(
            'ListInboundShipmentItemsByNextTokenResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_ListInboundShipmentItemsByNextTokenResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_ListInboundShipmentItemsByNextTokenResult ListInboundShipmentItemsByNextTokenResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_ListInboundShipmentItemsByNextTokenResult $value listInboundShipmentItemsByNextTokenResult
