...
class FBAInboundServiceMWS_Model_GetServiceStatusResponse extends FBAInboundServiceMWS_Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            'GetServiceStatusResult' => array(
                'FieldValue' => null,
                'FieldType' => 'FBAInboundServiceMWS_Model_GetServiceStatusResult'
            ),
     ...
     *
     * @return FBAInboundServiceMWS_Model_GetServiceStatusResult GetServiceStatusResult.
     */
     ...
     *
     * @param FBAInboundServiceMWS_Model_GetServiceStatusResult $value getServiceStatusResult
